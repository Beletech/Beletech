...
public interface IUserSearchClient {
	...
	Result<List<User>> listByUser(@RequestParam("userId") String userId);
	...
	Result<List<User>> listByDept(@RequestParam("deptId") String deptId);
	...
	Result<List<User>> listByPost(@RequestParam("postId") String postId);
	...
	Result<List<User>> listByRole(@RequestParam("roleId") String roleId);
