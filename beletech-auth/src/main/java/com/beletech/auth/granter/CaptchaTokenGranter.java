...
public class CaptchaTokenGranter extends AbstractTokenGranter {
	...
	private BeletechRedis beletechRedis;

	public CaptchaTokenGranter(AuthenticationManager authenticationManager,
							   AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, BeletechRedis beletechRedis) {
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		// 获取验证码
		String redisCode = beletechRedis.get(CacheNames.CAPTCHA_KEY + key);
		// 判断验证码
