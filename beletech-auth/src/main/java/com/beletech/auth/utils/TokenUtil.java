package com.beletech.auth.utils;
...
public class TokenUtil {
	...
	private static BeletechTenantProperties tenantProperties;
	 ...
	 */
	private static BeletechTenantProperties getTenantProperties() {
		if (tenantProperties == null) {
			tenantProperties = SpringUtil.getBean(BeletechTenantProperties.class);
		}
		return tenantProperties;
	}
	...
	public static boolean judgeTenant(Tenant tenant) {
		...
		if (StringUtil.equalsIgnoreCase(tenant.getTenantId(), BeletechConstant.ADMIN_TENANT_ID)) {
			return false;
		}
