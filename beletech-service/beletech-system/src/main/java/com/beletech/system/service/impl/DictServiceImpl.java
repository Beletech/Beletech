...
import com.beletech.system.mapper.DictMapper;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
	...
	public boolean submit(Dict dict) {
		...
		if (Func.isNotEmpty(dict.getId()) && dict.getParentId().longValue() == BeletechConstant.TOP_PARENT_ID) {
			...
			this.update(Wrappers.<Dict>update().lambda().set(Dict::getCode, dict.getCode()).eq(Dict::getCode, parent.getCode()).ne(Dict::getParentId, BeletechConstant.TOP_PARENT_ID));
		}
